...
#     ]
# }
# with open('grades.json', 'w') as fayl:
#     json.dump(data, fayl, indent=4)
# with open('grades.json', 'r') as fayl:
#     data = json.load(fayl)
# for oquvchi in data['oquvchilar']:
#     nom = oquvchi['name']
#     baholar = oquvchi['grades']
#     yigindi = sum(baholar)
#     print(f"{nom}: {', '.join(map(str, baholar))} = {yigindi}")
